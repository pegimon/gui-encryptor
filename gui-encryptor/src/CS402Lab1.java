...
//            c += new BigInteger((int) (p.charAt(i)) + "").add(factorial(Integer.parseInt(key))) + "#";
//        }
//        return c;
...
//            int Nindex = (index + Integer.parseInt(key)) % 26;
//            if (Nindex < 0) {
//                Nindex = alphabet.length() + Nindex;
//            }
//            char replaceVal = alphabet.charAt(Nindex);
//            c += replaceVal;
//        }
//        return c;
...
//                p +=(char)(new BigInteger(str[i]).subtract(factorial(Integer.parseInt(key)))).intValue();
//            }
//
//       return p;
//        lab 2
...
//        return p;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ceaser", "mono", "hillCipher", "playfair", "railFence", "vigenere", "autokey" }));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        XYSeries series1 = new XYSeries("encryption");
        XYSeries series2 = new XYSeries("decryption");
